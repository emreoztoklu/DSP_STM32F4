 ...
 * LPF design which is cut-off frequency in 70 Hz
*/
	...
	/*
	//CMSIS-DSP Convolution function
	...
	*/
	...
	serial_plot_output_signal();  // 10Hz will pass from lpf  100 and 500Hz will stop LPF
