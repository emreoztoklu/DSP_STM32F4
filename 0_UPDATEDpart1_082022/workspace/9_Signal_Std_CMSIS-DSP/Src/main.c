...
/******************************************************************/
	 ...
	 * Note: Pay Attention
	 *
	 * This CMSIS uses HW floating-point ABI: Hardware implementation
	 * MCU settings >tool settings
	 * */

	arm_std_f32((float32_t*)inputSignal_f32_1kHz_15kHz, (uint32_t)INPUT_SIGNAL_LEN_KHZ_1_15, (float32_t*)&g_std_value_cmsis);
	/*0.7875*/
/******************************************************************/
