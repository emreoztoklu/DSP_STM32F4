...
void float32_convolution(float32_t *sig_src_arr, float32_t *imp_response_arr, float32_t *sig_dest_arr, uint32_t sig_src_lenght, uint32_t imp_response_lenght){
...
void ui32_convolution(uint32_t *sig_src_arr, float32_t *imp_response_arr, uint32_t *sig_dest_arr, uint32_t sig_src_lenght, uint32_t imp_response_lenght){
