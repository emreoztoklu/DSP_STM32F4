...
/******************************************************************/
// we can use running sum to reduce noise, low pass filter

	running_sum_cal((float32_t *)inputSignal_f32_1kHz_15kHz,
...
/******************************************************************/
	...
	while(1){
		...
		serial_plot_all_2();  // Watch on Arduino serial plotter or https://x-io.co.uk/serial-oscilloscope/
	} //while loop
