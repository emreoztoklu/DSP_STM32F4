...
%------------------------------------------------------
%Implement low-pass filter of cutoff freq 70Hz,
%Sampling at 2000Hz (2Khz)
%FIR1 (kernel_lenght-1, cutoff/Sampling_rate)

Fc = 70;        %filter Cutof freq
Fs = 2000;      % sampling freq


h = fir1(100, Fc/Fs);  %argu1: number of point-1 (101,1 - 1 = 100 point) 
%plot(h);
...
%Save input_signal to csv

csvwrite('Signal_10hz_100hz_500hz.txt', signal);
